...
String.prototype.getParameter = function (key) {  
	    ...
	    $(function () {  
	        ...
	        var s = location.href;  
	        // 获取编号  
	       var id = s.getParameter("phoneNum");  
	       document.getElementById("phoneNum").value= id;
	    })
			...
			<div class="g-container template-style J_UserRegister" id="g-cfg" data-module="account" data-fo-help="1">
				...
				<div class="new-register">
					...
					<div class="form-area next-form">
						<form action="regist" method="post" id="patient" name="patient">
							<div class="g-tips-box-error hide">
						   		<span class="gi gi-error"></span>
						   		<span class="content">
								
								<input type="hidden" name="phone" id="phoneNum" value="">
							...
							<ul>
								<li class="first-line"><label>真实姓名：</label><input type="text" class="text" name="name" data-required="1" value="" data-validtips="请务必填写本人姓名，注册后不能修改"/></li>
								<li class="second-line"><label>身份证号：</label><input type="text" class="text" name="INnumber" data-required="1" value=""  data-validtips="请务必填写本人身份证号，注册后不能修改" maxlength="18"/></li>
							</ul>
							<h5 class="title">
								常用邮箱设置<span class="extra-tip">找回密码时用来验证身份</span>
							</h5>
							<ul>
								<li class="first-line"><label>常用邮箱：</label><input type="email" data-required="1" class="text" name="email" placeholder="输入需符合邮箱格式" value=""/></li>
							</ul>
							 <div class="action-line">
								
								<button class="gbn gbt-blue2" id="regSubmit" type="submit">注册</button>
							</div>
						</form>
					</div>
				</div>
