							...
							<div class="row">
									<div class="span6">
										<div class="dataTables_filter" id="example_filter">
											<input type="text" placeholder="医生编号、姓名">
											<button class="btn btn-primary" style="margin-left: 10px">搜索</button>
										</div>
									</div>
									<div style="float:right">
										<button class="btn btn-success" onclick="window.location.href='addDoctorDetail.jsp'">新添加 <i class="icon-plus icon-white"></i></button>
									</div>
							</div>
							<table>
								<caption></caption>
								...
								<tbody>
									<tr>
										...
										<td>主治医师</td>
										<td>
											<button class="btn btn-primary" onclick="window.location.href='alterDoctorDetail.jsp'">
												<i class="icon-pencil icon-white"></i>编辑</button>
										    <button class="btn btn-success" onclick="window.location.href='doctorDetail.jsp'">
