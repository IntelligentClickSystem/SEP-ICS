				...
				<div class="wrap">
					...
					<div class="person-right">
						<div class="order-list  border-left">
							<div class="g-blue-title title">医生信息详情</div>
							...
							<div id="userinfo-display" class="gfm-line">
								<ul>
									...
									<li class="gfm-item">
										<span class="gfm-left">工号：</span>
										<label for="">rj12301100</label></li>
									<li class="gfm-item">
										<span class="gfm-left">科室：</span>
										<label for="">内科</label></li>
									<li class="gfm-item">
										<span class="gfm-left">职称：</span>
										<label for="">主治医师</label></li>
									<li class="gfm-item">
									...
									<li class="auth-line g-clear">
										<div class="gfm-btn gfm-call">
											<a href="doctorInfoManage.jsp" class="diagnosing-call">返回</a>
										</div>
									</li>							
								</ul>
							</div>
