...
<body style="min-width: 980px;"> 
	...
	<ul class="none-border">
		<li class="myorder"><a class="current myorder-a" href="diagnoseInfo.jsp"><span class="gi2 gi-order"></span>我的就诊信息</a></li>
	</ul>
				...
				<div id="errorTipsDv" class="g-tips-box-error tips-box hide">
					...
					<table cellspacing="0" cellpadding="0">
					 ...
					 <td>
					  ...
					  <td class="text-left">
					  	 <a href="#" target="_blank">doctor1</a><a href="evaluateDoctor.jsp" class="gbn gbt-blue2 my-send fadeInDown animated" target="_blank"><i></i>评价医生</a><br><small>
					  	 <a href="#" target="_blank">内科-风湿科</a><br>
					  </small></td>
					  <td>
					  姜栋煜
					  </td>
					 ...
					 <td>
					  ...
					  <td class="text-left">
					  	 <a href="#" target="_blank">doctor1</a><br><small>
					  	 <a href="#" target="_blank">内科-风湿科</a><br>
					  </small></td>
					  <td>
					  姜栋煜
