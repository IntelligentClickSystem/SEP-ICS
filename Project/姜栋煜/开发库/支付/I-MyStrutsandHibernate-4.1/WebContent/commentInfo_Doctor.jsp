...
<body style="min-width: 980px;"> 
	...
	<p class="left-head js-user-avatar">
		...
		<span><strong>范春雷医师</strong>欢迎来到智能挂号系统</span>
	</p>
	<div class="clear"></div>	
	<ul class="none-border">
		<li class="my-plus"><a class=" my-plus-a" href="evaluateInfo.jsp"><span class="gi2 gi-plus"></span>评价医生</a></li>
		<li class="myorder"><a class="current myorder-a" href="evaluateInfoHistroy.jsp"><span class="gi2 gi-order"></span>历史评价</a></li>
	</ul>
