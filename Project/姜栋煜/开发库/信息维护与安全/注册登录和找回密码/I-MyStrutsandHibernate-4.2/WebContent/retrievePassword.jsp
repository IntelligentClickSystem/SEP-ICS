				...
				<div class="new-register">
					<div class="form-area">
						<form id="passwordForm" name="passwordForm" method="post">
							...
							<ul class="docorFirst">
								<li class="mobile-line"><label>邮箱：</label><input type="text" id="mailbox" autocomplete="off" name="mailbox" class="text loginId" data-required="1" pattern="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" data-message="请输入正确的邮箱" value="" data-offset="120" data-validcode="ml130"></li>
							</ul>
