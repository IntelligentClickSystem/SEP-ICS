				...
				<div class="wrap">
					<div class="person-left">
						<p class="left-head js-user-avatar">
							<img src="./files_ji/young-f.png" alt="女"> <span><strong>姜栋煜</strong>欢迎来到智能挂号系统</span>
						</p>
						<div class="clear"></div>
						<ul class="none-border">
							<li class="myorder"><a class="current myorder-a"
								href="evaluate.jsp"><span class="gi2 gi-order"></span>评价就诊</a></li>
						...
						<div class="order-list  border-left">
							...
							<table cellspacing="0" cellpadding="0">
								...
								<tbody>
									<tr>
										<td>2012-01-02</td>
										<td class="text-left"><a href="#" target="_blank">Doctor1<br></a><a
											href="#" target="_blank">内科-风湿科</a><br></td>
										<td>姜栋煜</td>
								...
								<table cellspacing="0" cellpadding="0">
									...
									<tbody>
										<tr>
											...
											<td class="text-left"><input type="hidden" value="0">
											<p onmouseover="rate(this,event)">
													医生态度： <img src="files_ji/icon_star_1.gif" title="很烂">
													<img src="files_ji/icon_star_1.gif" title="一般"> <img
														src="files_ji/icon_star_1.gif" title="还好"> <img
														src="files_ji/icon_star_1.gif" title="较好"> <img
														src="files_ji/icon_star_1.gif" title="很好">
												</p> <input type="hidden" value="0">
											<p onmouseover="rate(this,event)">
													治疗效果： <img src="files_ji/icon_star_1.gif" title="很烂">
													<img src="files_ji/icon_star_1.gif" title="一般"> <img
														src="files_ji/icon_star_1.gif" title="还好"> <img
														src="files_ji/icon_star_1.gif" title="较好"> <img
														src="files_ji/icon_star_1.gif" title="很好">
											...
											<p onmouseover="rate(this,event)">
													其他因素： <img src="files_ji/icon_star_1.gif" title="很烂">
													<img src="files_ji/icon_star_1.gif" title="一般"> <img
														src="files_ji/icon_star_1.gif" title="还好"> <img
														src="files_ji/icon_star_1.gif" title="较好"> <img
														src="files_ji/icon_star_1.gif" title="很好">
												</p> <br /> <input type="submit" value="提交"></input></td>
										</tr>
									</tbody>
								</table>
