				...
				<div class="wrap">
					<div class="person-left">
						...
						<ul class="none-border">
							<li class="myorder"><a href="unfinishedDiagnoseList.jsp">
									<span></span>待接诊列表
							</a></li>
							<li><a class="current myorder-a" href="doneDiagnoseList.jsp"><span></span>已接诊列表</a>
							</li>
							<li><a href="diagnosing.jsp"><span></span>开始接诊</a></li>
						</ul>
					</div>
						...
						<div class="order-list  border-left">
							<form id="orderFilter" action="#" class="g-clear">
								...
								<div class="picker g-left">
									<label> 按接诊时间筛选： </label> <span class="g-datepicker"> <input
										type="date" id="startTime" name="shiftDateBegin"
										class="text hasDatepicker" style="width: 135px;" />
									</span> <span>-</span> <span class="g-datepicker"> <input
										type="date" id="endTime" name="shiftDateEnd"
										class="text hasDatepicker" style="width: 135px;" />
									</span>
								</div>
								<div class="action g-left">
									<a class="gb gb-grey2" href="#" id="sureBt"> <span
										class="gb-right"><span class="gb-text-btn">确定</span></span>
									</a>
								</div>
							</form>
							<table>
