					...
					<div class="person-right">
						<div class="order-list  border-left">
							...
							<div id="userinfo-display" class="gfm-line">
								<ul>
									<li class="gfm-item liMob"><span class="gfm-left">姓名：</span>
										<label for="">吉训煜</label></li>
									<li class="gfm-item liMob"><span class="gfm-left">性别：</span>
										<label for="">男</label></li>
									<li class="gfm-item liMob"><span class="gfm-left">年龄：</span>
										<label for="">22</label></li>
									<li class="gfm-item"><span class="gfm-left">就诊卡号：</span> <label
										for="">rj12301100</label></li>
