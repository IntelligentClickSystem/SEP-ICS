				...
				<div class="wrap">
					<div class="person-left">
						<p class="left-head js-user-avatar">
							<img src="./files_ji/young-m.png" /> <span><strong>Admin</strong>欢迎来到数字医院智能系统</span>
						</p>
						<div class="clear"></div>
						<ul class="none-border">
							<li><a href="doctorWorkData.jsp"> <span></span>医生接诊数据
							</a></li>
							<li><a href="doctorSort.jsp" class="current myorder-a"><span></span>医生综合排名</a>
							</li>
							<li><a href="doctorSort.jsp"><span></span>录入病人信息</a></li>
							<li><a href="doctorSort.jsp"><span></span>录入医生信息</a></li>
							<li><a href="doctorSort.jsp"><span></span>修改医生信息</a></li>
							<li><a href="doctorSort.jsp"><span></span>删除医生信息</a></li>
						</ul>
					</div>
						...
						<div class="order-list  border-left">
							<form id="orderFilter" action="#" class="g-clear">
								...
								<div class="check g-left">
									<label> 按科室筛选： </label> <select name="orderState">
